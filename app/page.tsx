    ...
    <section className="mx-auto max-w-7xl px-4 pb-24 pt-12 md:px-8 md:pt-20">
      ...
      <div className="mt-12 space-y-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <Link href="/guides">
            <Button size="sm" variant="outline">View all guides</Button>
          </Link>
        </div>
        <div className="grid gap-4 md:grid-cols-3">
          <Link href="/guides/choose-preschool" className="surface flex h-full flex-col p-4">
            <h3 className="font-semibold">How to choose a preschool</h3>
            <p className="mt-2 flex-1 text-sm text-muted-foreground">A parent-first shortlist and tour framework.</p>
          </Link>
          <Link href="/guides/preschool-tuition" className="surface flex h-full flex-col p-4">
            <h3 className="font-semibold">Tuition guide</h3>
            <p className="mt-2 flex-1 text-sm text-muted-foreground">How to compare cost realistically across schools.</p>
          </Link>
          <Link href="/guides/verified-schools" className="surface flex h-full flex-col p-4">
            <h3 className="font-semibold">Verified schools guide</h3>
            <p className="mt-2 flex-1 text-sm text-muted-foreground">How verification works and what it means.</p>
          </Link>
        </div>
      </div>
    </section>
